...
`$XDG_STATE_HOME/omarchy/You-ne5.yfocus/queue.json`, defaulting to
`~/.local/state/omarchy/You-ne5.yfocus/queue.json`.
...
./bin/yfocus path           # /home/<you>/.local/state/omarchy/You-ne5.yfocus/queue.json
